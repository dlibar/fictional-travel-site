...
class Adult extends Person {
	payTaxes() {
		console.log(this.name + " now owes $0.00 in taxes");
	}
}

alert("Another new test ongoing");

var doune = new Person("Doune Libar", "Brown");
doune.greet();

var rosanne = new Adult("Madjissem Kongar", "Orange");
rosanne.greet();
rosanne.payTaxes();
...
var MobileMenu = function () {
	function MobileMenu() {
		...
		/*	$(".site-header__menu-icon").click(function() {
  		console.log("Top right icon was just clicked");
  	});*/
	}
	...
	_createClass(MobileMenu, [{
		...
		value: function toggleTheMenu() {
			//	console.log("New way of implementing the click function!");
